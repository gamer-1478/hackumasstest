        ...
        <div className="Sponsors" id="sponsors">
            ...
            <div className="WhySponsor">
                <div className="WhySponsorLeft">
                    <h1 className="heading">Why should you sponsor us?</h1>
                    <p className="p">Sponsoring HackUMass is a strategic opportunity to engage with some of the brightest minds in technology and innovation.  As a sponsor, you'll have direct access to a diverse pool of talented students and professionals eager to tackle real-world challenges.  This event serves as a breeding ground for cutting-edge ideas and solutions, offering your company a chance to gain fresh perspectives and innovative approaches to your business challenges.</p>
                    
                    <button className="WhySponsorButton" onClick={() => window.open("mailto:team@hackumass.com", "_blank")}>
                        <p style={{ margin: "auto" }}>Sponsor HackUMass</p>
                    </button>
                </div>
                <div className="WhySponsorRight">
                    <Image src="/SponsorUsRight.png" sizes={2000} width={0} height={0} priority={true} />
                </div>
            </div>
            <div className="LandingAboutHeader">
